...
class CalculatorTests: XCTestCase {
    ...
    func testDescription() {
        ...
        XCTAssertEqual(brain.pushOperand(3)!, 3)
        XCTAssertEqual(brain.pushOperand(6)!, 6)
        XCTAssertEqual(brain.pushOperand(9)!, 9)
        XCTAssertEqual(brain.performOperation("×")!, 54)
        XCTAssertEqual(brain.performOperation("+")!, 57)
        XCTAssertEqual(brain.description, "3 + 6 × 9")
        ...
        XCTAssertEqual(brain.performOperation("+")!, 9)
        XCTAssertEqual(brain.pushOperand(9)!, 9)
        XCTAssertEqual(brain.performOperation("×")!, 81)
        XCTAssertEqual(brain.description, "(3 + 6) × 9")
